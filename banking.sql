...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2018 at 08:46 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `login` (INOUT `uname` VARCHAR(20), IN `pwd` VARCHAR(20), OUT `stts` BOOLEAN, OUT `msg` VARCHAR(50), OUT `id_nsb` INT)  NO SQL
BEGIN
DECLARE jml int;
